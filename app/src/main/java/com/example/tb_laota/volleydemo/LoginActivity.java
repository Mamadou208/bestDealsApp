...
import com.example.tb_laota.volleydemo.app.AppConfig;
import com.example.tb_laota.volleydemo.app.AppController;
import com.example.tb_laota.volleydemo.helper.SQLiteHandler;
import com.example.tb_laota.volleydemo.helper.SessionManager;
...
public class LoginActivity extends Activity {
    ...
    private void checkLogin(final String email, final String password) {
        ...
        StringRequest strReq = new StringRequest(Method.GET, AppConfig.URL_LOGIN+email, new Response.Listener<String>() {
